...
class Entities(Enum):
    """
    An enumeration class for the entities available at Microsoft's Academic \
    Knowledge API
    """
    PAPER = 0
    AUTHOR = 1
...
class AcademicObject(object):
    ...
    def as_dict(self):
        ...
        """
        return dict(
            [(key, value[0]) for key, value in list(self.attrs.items())])
...
class AcademicPaper(AcademicObject):
    """
    A class representing an article listed on Microsoft's Academic Knowledge \
    API.
    """
    ...
    def __init__(self):
        ...
        self.attrs = {
            ...
            'num_citations': [0, 'CC', 'Nbr of Cites',
                              5],  # pylint: disable-msg=C0326
            'cites': [[], 'Ci', 'Cites', 6],  # pylint: disable-msg=C0326
            'field_of_study': [None, 'F', 'Field of Study',
                               7],  # pylint: disable-msg=C0326
            'journal': [None, 'J', 'Journal', 8],  # pylint: disable-msg=C0326
            'conference': [None, 'C', 'Conference',
                           9],  # pylint: disable-msg=C0326
            'references': [None, 'RId', 'References',
                           10],  # pylint: disable-msg=C0326
            'excerpt': [None, 'W', 'Excerpt', 11],  # pylint: disable-msg=C0326
            'metadata': [None, 'E', 'Metadata',
                         12]  # pylint: disable-msg=C0326
        }


class AcademicPaperMetadata(AcademicObject):
    """
    A class representing the metadata for articles listed on Microsoft's \
    ...
    def __init__(self):
        ...
        # (3) an ordering index.
        self.attrs = {
            'name': [None, 'DN', 'Display Name',
                     0],  # pylint: disable-msg=C0326
            ...
            'first_page': [None, 'FP', 'First Page',
                           5],  # pylint: disable-msg=C0326
            'last_page': [None, 'LP', 'Last Page',
                          6],  # pylint: disable-msg=C0326
            'doi': [None, 'DOI', 'Digital Object Id',
                    7],  # pylint: disable-msg=C0326
            'citation_contexts': [None, 'CC', 'Citation Contexts',
                                  8],  # pylint: disable-msg=C0326
            'inverted_abstract': [None, 'IA', 'Inverted Abstract',
                                  9]  # pylint: disable-msg=C0326
        }
...
class AcademicAuthor(AcademicObject):
    """
    A class representing an author retrieved from Microsoft's Academic
    Knowledge API.
    """
    ...
    def __init__(self):
        ...
        self.attrs = {
            ...
            'name': [None, 'AuN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DAuN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              3],  # pylint: disable-msg=C0326
...
class AcademicAuthorMetadata(AcademicObject):
    ...
    def __init__(self):
        ...
        # (2) a user-suitable label for the item, and
        # (3) an ordering index.
        self.attrs = {'affiliation': [None, 'LKA', 'Affiliation', 0]}
...
class AcademicAffiliation(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            ...
            'name': [None, 'AfN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DAfN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              3],  # pylint: disable-msg=C0326
            'metadata': [None, 'E', 'Metadata', 4]  # pylint: disable-msg=C0326
...
class AcademicAffiliationMetadata(AcademicObject):
    ...
    def __init__(self):
        ...
        # (2) a user-suitable label for the item, and
        # (3) an ordering index.
        self.attrs = {'paper_count': [None, 'PC', 'Paper Count', 0]}
...
class AcademicFieldOfStudy(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            ...
            'name': [None, 'FN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DFN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              3],  # pylint: disable-msg=C0326
            'hierarchy_level': [0, 'FL', 'Level in hierarchy',
                                4],  # pylint: disable-msg=C0326
            'parent': [None, 'FP', 'Parent', 5],  # pylint: disable-msg=C0326
            'children': [None, 'FC', 'Children',
                         6]  # pylint: disable-msg=C0326
        }
...
class AcademicConferenceSeries(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            'id': [0, 'Id', 'ID', 0],  # pylint: disable-msg=C0326
            'name': [None, 'CN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DCN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              3],  # pylint: disable-msg=C0326
            'field_of_study': [None, 'F', 'Field of Study',
...
class AcademicConferenceInstance(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            'id': [0, 'Id', 'ID', 0],  # pylint: disable-msg=C0326
            'name': [None, 'CIN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DCN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'location': [None, 'CIL', 'Location',
                         3],  # pylint: disable-msg=C0326
            'start_date': [None, 'CISD', 'Start Date',
                           4],  # pylint: disable-msg=C0326
            'end_date': [None, 'CIED', 'End Date',
                         5],  # pylint: disable-msg=C0326
            'conference_series': [None, 'PCS', 'Conference Series',
                                  6],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              7]  # pylint: disable-msg=C0326
        }
...
class AcademicConferenceInstanceMetadata(AcademicObject):
    ...
    def __init__(self):
        ...
        # (2) a user-suitable label for the item, and
        # (3) an ordering index.
        self.attrs = {'full_name': [None, 'FN', 'Full Name', 0]}
...
class AcademicJournal(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            'id': [0, 'Id', 'ID', 0],  # pylint: disable-msg=C0326
            'name': [None, 'JN', 'Normalized Name',
                     1],  # pylint: disable-msg=C0326
            'display_name': [None, 'DJN', 'Name',
                             2],  # pylint: disable-msg=C0326
            'num_citations': [0, 'CC', 'Citations',
                              3]  # pylint: disable-msg=C0326
        }
...
class AcademicInterpretation(AcademicObject):
    ...
    def __init__(self):
        ...
        # (3) an ordering index.
        self.attrs = {
            'parse': [None, 'parse', 'Parsing Explanation',
                      0],  # pylint: disable-msg=C0326
...
class AcademicHistogram(AcademicObject):
    ...
    def __init__(self):
        ...
        # (3) an ordering index.
        self.attrs = {
            'attribute': [None, 'attribute', 'Attribute',
                          0],  # pylint: disable-msg=C0326
            'values': [None, 'distinct_values', 'Values',
                       1],  # pylint: disable-msg=C0326
            'count': [None, 'total_count', 'Count',
                      2],  # pylint: disable-msg=C0326
...
class AcademicHistogramValue(AcademicObject):
    ...
    def __init__(self):
        ...
        self.attrs = {
            ...
            'probability': [None, 'prob', 'Probability',
                            1],  # pylint: disable-msg=C0326
...
class AcademicPaperParser(AcademicParser):
    ...
    def parse(response):
        ...
        for key in list(response.keys()):
            ...
            if key == 'AA':
                target[key] = [
                    AcademicAuthorParser.parse(author) for author in value
                ]
            elif key == 'F':
                target[key] = [
                    AcademicParser._parse(fos, AcademicFieldOfStudy)
                    for fos in value
                ]
            elif key == 'E':
                if isinstance(value, str):
                    value = json.loads(value)
                target[key] = AcademicParser._parse(value,
...
class AcademicInterpretationParser(AcademicParser):
    ...
    def parse(response):
        ...
        target['rules'] = [
            AcademicInterpretationRuleParser.parse(rule)
...
class AcademicHistogramParser(AcademicParser):
    ...
    def parse(response):
        ...
        target['data'] = [
            AcademicParser._parse(val, AcademicHistogramValue)
